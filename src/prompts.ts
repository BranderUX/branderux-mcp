...
4. define_entity for the real data shapes — writable entities (bookings/orders/enquiries) get the right writePolicy per the coherence rule and are end-user-scoped, never public-read — then seed_records (marked _demo) or wire live sources.
